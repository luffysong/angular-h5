...
angular.module('defaultApp.directive').directive('loading', [
    ...
    function ($rootScope, $compile) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                $rootScope.loadingInst[attrs.loading] = angular.isUndefined($rootScope.loadingInst[attrs.loading])?true:$rootScope.loadingInst[attrs.loading];
    ...
    return {
        show: function(name){
            if(angular.isUndefined($rootScope.loadingInst[name]))return;
